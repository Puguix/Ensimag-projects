...
import './CSS/LoadingPage.css'; // Importez le fichier CSS pour le style
import rouletteWheelImage from '../Assets/rouletteWheel.png'; // Importez l'image

const LoadingPage = () => {
    return (
        <div className="loading-container" style={{position: 'relative', width: '100%', height: '100%'}}>
            <img src={rouletteWheelImage} alt="Loading" className="loading-spinner"/>
            <div id="bg-wrap" style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 1}}>
                <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
                    <defs>
                        <radialGradient id="Gradient1" cx="50%" cy="50%" fx="0.441602%" fy="50%" r=".5">
                            <animate attributeName="fx" dur="34s" values="0%;3%;0%" repeatCount="indefinite"/>
                            <stop offset="0%" stopColor="rgba(255, 165, 0, 1)"/>
