...
elaboration_vivado: | analysis_vivado $(SIM_DIR)
	$(call quiet-command, cd $(SIM_DIR) ; $(XILINX_PREFIX)xelab tb_$(TOP) -cc gcc -initfile=$(XILINX_VIVADO)/data/xsim/ip/xsim_ip.ini -L xpm -nolog -debug typical -generic_top "mutant=${MUTANTS}", "Elaborate..")
