...
static volatile uint32_t *led          = (volatile uint32_t *)REG_LEDS_ADDR;
static volatile uint32_t *push         = (volatile uint32_t *)REG_PIN_ADDR;
