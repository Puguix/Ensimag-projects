...
var paper = function (self, undefined) {
    ...
    var Base = new (function () {
        var hidden = /^(statics|enumerable|beans|preserve)$/,
            ...
            describe =
                ...
                function (obj, name) {
                    var get =
                        obj.__lookupGetter__ && obj.__lookupGetter__(name);
                    return get
                        ? {
                              get: get,
        ...
        function inject(dest, src, enumerable, beans, preserve) {
            ...
            function field(name, val) {
                ...
                if (!preserve || !prev) {
                    ...
                    if (
                        (describe(dest, name) || { configurable: true })
                            .configurable
                    ) {
        ...
        function set(obj, args, start) {
            for (var i = start, l = args.length; i < l; i++) {
                ...
                for (var key in props)
                    if (props.hasOwnProperty(key)) obj[key] = props[key];
            }
            return obj;
        }
        ...
        statics: {
            ...
            getNamed: function (list, name) {
                ...
                if (list._hasObject === undefined)
                    list._hasObject =
                        list.length === 1 && Base.isPlainObject(arg);
                if (list._hasObject)
            ...
            solveCubic: function (a, b, c, d, roots, min, max) {
                ...
                if (abs(a) < EPSILON) {
                    ...
                    var t = q / a,
                        ...
                        rd =
                            td > 0
                                ? 1.324717957244746 * Math.max(r, sqrt(td))
                                : r,
                        x0 = x - s * rd;
                    if (x0 !== x) {
                        do {
                ...
                var count = Numerical.solveQuadratic(
                        a,
                        b1,
                        c2,
                        roots,
    ...
    var Point = Base.extend(
        {
            ...
            getAngle: function () {
                return (
                    (this.getAngleInRadians.apply(this, arguments) * 180) /
                    Math.PI
                );
            },
        ...
        },
        {
            ...
            getDirectedAngle: function () {
                var point = Point.read(arguments);
                return (
                    (Math.atan2(this.cross(point), this.dot(point)) * 180) /
                    Math.PI
                );
            },
            ...
            project: function () {
                var point = Point.read(arguments),
                    scale = point.isZero()
                        ? 0
                        : this.dot(point) / point.dot(point);
    ...
    var Size = Base.extend(
        {
            ...
            isZero: function () {
                return (
                    Numerical.isZero(this.width) &&
                    Numerical.isZero(this.height)
                );
            },
    ...
    var Item = Base.extend(
        ...
        })(),
        {
            ...
            _initialize: function (props, point) {
                ...
                if (
                    ...
                    (!settings.insertItems &&
                        !(hasProps && props.insert === true))
                ) {
            ...
            setName: function (name) {
                ...
                if (name && owner) {
                    ...
                    (namedChildren[name] = namedChildren[name] || []).push(
                        this
                    );
        ...
        ),
        {
            ...
            changeSelection: function (flag, selected) {
                ...
                this.setSelection(
                    selected ? selection | flag : selection & ~flag
                );
            },
            ...
            },
            {
                ...
                getBounds: function (matrix, options) {
                    ...
                    if (!opts.stroke || this.getStrokeScaling())
                        opts.cacheItem = this;
                    var bounds = this._getCachedBounds(
                        hasMatrix && matrix,
                        opts
                    );
        ...
        ),
        {
            ...
            getScaling: function (_dontLink) {
                ...
                return (
                    scaling &&
                    new ctor(scaling.x, scaling.y, this, "setScaling")
                );
            },
        ...
        },
        {
            ...
            copyAttributes: function (source, excludeMatrix) {
                ...
                if (!excludeMatrix) this._matrix.initialize(source._matrix);
        ...
        new (function () {
            ...
            function hitTestAll() {
                ...
                options = Base.set({}, options, {
                    match: function (hit) {
                        if (!callback || callback(hit)) results.push(hit);
                    },
                });
        ...
        })(),
        {
            _hitTest: function (point, options, parentViewMatrix) {
                ...
                function checkBounds(type, part) {
                    ...
                    if (
                        point.subtract(pt).divide(tolerancePadding).length <= 1
                    ) {
            ...
            statics: {
                _getItems: function _getItems(
                    ...
                    for (
                        var i = 0, l = children && children.length;
                        i < l;
                        i++
                    ) {
                        var child = children[i],
        ...
        },
        {
            ...
            insertChild: function (index, item, _preserve) {
                var res = item
                    ? this.insertChildren(index, [item], _preserve)
                    : null;
                return res && res[0];
            },
            ...
            },
            {
                ...
                transform: function (
                    ...
                    if (
                        ...
                        this._position = matrix._transformPoint(
                            position,
                            position
                        );
                    }
        ...
        ),
        {
            _setStyles: function (ctx, param, viewMatrix) {
                ...
                if (style.hasShadow()) {
                    var pixelRatio = param.pixelRatio || 1,
                        ...
                        blur = mx.transform(
                            new Point(style.getShadowBlur(), 0)
                        ),
            ...
            draw: function (ctx, param, parentStrokeMatrix) {
                ...
                var matrices = param.matrices,
                    ...
                    matrix = this._matrix,
                    globalMatrix =
                        matrices[matrices.length - 1].appended(matrix);
    ...
    var Shape = Item.extend(
        ...
        new (function () {
            function getCornerCenter(that, point, expand) {
                ...
                if (!radius.isZero()) {
                    ...
                    for (var i = 0; i < 4; i++) {
                        ...
                        if (
                            (expand ? rect.expand(expand) : rect).contains(
                                point
                            )
                        )
                            return center;
            ...
            function isOnEllipseStroke(point, radius, padding, quadrant) {
                ...
                return (
                    (!quadrant || vector.quadrant === quadrant) &&
                    vector
                    ...
                    if (hitStroke || hitFill) {
                        ...
                        if (type === "rectangle") {
                            ...
                            if (center) {
                                ...
                                var rect = new Rectangle(this._size).setCenter(
                                        0,
                                        0
                                    ),
    ...
    var Raster = Item.extend(
        ...
        },
        {
            ...
            getSubRaster: function () {
                ...
                raster.translate(
                    rect.getCenter().subtract(this.getSize().divide(2))
                );
            ...
            toDataURL: function () {
                ...
                return canvas
                    ? canvas.toDataURL.apply(canvas, arguments)
                    : null;
            },
            ...
            getAverageColor: function (object) {
                ...
                if (path)
                    path.draw(
                        ctx,
                        new Base({ clip: true, matrices: [matrix] })
                    );
            ...
            getPixel: function () {
                var point = Point.read(arguments);
                var data = this.getContext().getImageData(
                    point.x,
                    point.y,
                    1,
                    1
            ...
            createImageData: function () {
                var size = Size.read(arguments);
                return this.getContext().createImageData(
                    size.width,
                    size.height
                );
            },
    ...
    var SymbolItem = Item.extend({
        ...
        initialize: function SymbolItem(arg0, arg1) {
            if (
                ...
                this.setDefinition(
                    arg0 instanceof SymbolDefinition
                        ? arg0
                        : new SymbolDefinition(arg0)
                );
        },
        ...
        _getBounds: function (matrix, options) {
            ...
            return item._getCachedBounds(
                item._matrix.prepended(matrix),
                options
            );
        },

        _hitTestSelf: function (point, options, viewMatrix, strokeMatrix) {
            var res = this._definition._item._hitTest(
                point,
                options,
                viewMatrix
            );
            ...
            if (!type || type === "catmull-rom") {
                ...
                if (!_first && prev) {
                    ...
                    this.setHandleIn(
                        N !== 0
                            ? new Point(
                                  (d2_2a * p0._x + A * p1._x - d1_2a * p2._x) /
                                      N -
                                      p1._x,
                                  (d2_2a * p0._y + A * p1._y - d1_2a * p2._y) /
                                      N -
                                      p1._y
                              )
                            : new Point()
                ...
                if (!_last && next) {
                    ...
                    this.setHandleOut(
                        N !== 0
                            ? new Point(
                                  (d1_2a * p2._x + A * p1._x - d2_2a * p0._x) /
                                      N -
                                      p1._x,
                                  (d1_2a * p2._y + A * p1._y - d2_2a * p0._y) /
                                      N -
                                      p1._y
                              )
                            : new Point()
                ...
                throw new Error(
                    "Smoothing method '" + type + "' not supported."
                );
            }
        },
    ...
    var Curve = Base.extend(
        {
            ...
            isLast: function () {
                ...
                return (
                    (path &&
                        this._segment1._index === path._curves.length - 1) ||
                    false
                );
            },
            ...
            divideAtTime: function (time, _setHandles) {
                ...
                if (time >= tMin && time <= tMax) {
                    var parts = Curve.subdivide(this.getValues(), time),
                        ...
                        path = this._path;
                    if (setHandles) {
                        segment1._handleOut.set(
                            left[2] - left[0],
                            left[3] - left[1]
                        );
                        segment2._handleIn.set(
                            right[4] - right[6],
                            right[5] - right[7]
                        );
                    }
            ...
            statics: {
                ...
                getTimeOf: function (v, point) {
                    ...
                    for (var c = 0; c < 2; c++) {
                        ...
                        for (var i = 0; i < count; i++) {
                            t = roots[i];
                            if (
                                point.isClose(Curve.getPoint(v, t), geomEpsilon)
                            )
                                return t;
                        }
                    }
                ...
                getNearestTime: function (v, point) {
                    if (Curve.isStraight(v)) {
                        ...
                        if (det === 0) return 0;
                        var u =
                            ((point.x - p1x) * vx + (point.y - p1y) * vy) / det;
                        return u < 1e-12
                            ? 0
                            : u > 0.999999999999
                            ? 1
                ...
                isFlatEnough: function (v, flatness) {
                    var p1x = v[0],
                        ...
                        vy = 3 * c2y - 2 * p2y - p1y;
                    return (
                        Math.max(ux * ux, vx * vx) +
                            Math.max(uy * uy, vy * vy) <=
        ...
        Base.each(
            ...
            function (test, name) {
                this[name] = function () {
                    var seg1 = this._segment1,
                        seg2 = this._segment2;
                    return test(
                        new Line(seg1._point, seg2._point),
                        seg1._handleOut,
                        seg2._handleIn
                    );
                };
            ...
            },
            {
                ...
                isHorizontal: function () {
                    return (
                        this.isStraight() &&
                        Math.abs(this.getTangentAtTime(0.5).y) < 1e-7
                    );
                },
                ...
                isVertical: function () {
                    return (
                        this.isStraight() &&
                        Math.abs(this.getTangentAtTime(0.5).x) < 1e-7
                    );
                },
            }
        ),
        {
            ...
            getLocationOf: function () {
                return this.getLocationAtTime(
                    this.getTimeOf(Point.read(arguments))
                );
            },
        ...
        new (function () {
            ...
            function getIterations(a, b) {
                return Math.max(
                    2,
                    Math.min(16, Math.ceil(Math.abs(b - a) * 32))
                );
            }
        ...
        new (function () {
            function addLocation(
                ...
                var excludeStart = !overlap && param.excludeStart,
                    ...
                    tMin = 4e-7,
                    tMax = 1 - tMin;
                if (t1 == null) t1 = Curve.getTimeOf(v1, p1);
                if (
                    t1 !== null &&
                    t1 >= (excludeStart ? tMin : 0) &&
                    t1 <= (excludeEnd ? tMax : 1)
                ) {
                    if (t2 == null) t2 = Curve.getTimeOf(v2, p2);
                    if (
                        t2 !== null &&
            ...
            function addCurveIntersections(
                ...
                if (++recursion >= 48 || ++calls > 4096) return calls;
                var q0x = v2[0],
                    q0y = v2[1],
                    q3x = v2[6],
                    q3y = v2[7],
                ...
                if (Math.max(uMax - uMin, tMaxNew - tMinNew) < 1e-9) {
            ...
            function addCurveLineIntersections(
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    if (tl !== null) {
                        ...
                        if (
                            !param.excludeEnd ||
                            t2 > Numerical.CURVETIME_EPSILON
                        ) {
                            addLocation(
                                locations,
                                param,
            ...
            return {
                statics: {
                    _getIntersections: function (
                        ...
                        if (!v2) {
                            return Curve._getSelfIntersection(
                                v1,
                                c1,
                                locations,
                                param
                        ...
                        if (
                            !(
                                max(c1p1x, c1s1x, c1s2x, c1p2x) + epsilon >
                    ...
                    getOverlaps: function (v1, v2) {
                        ...
                        var flip =
                                getSquaredLineLength(v1) <
                                getSquaredLineLength(v2),
                            l1 = flip ? v2 : v1,
                            l2 = flip ? v1 : v2,
                            line = new Line(l1[0], l1[1], l1[6], l1[7]);
                        if (
                            line.getDistance(new Point(l2[0], l2[1])) <
                                geomEpsilon &&
                            line.getDistance(new Point(l2[6], l2[7])) <
                                geomEpsilon
                        ) {
                            if (
                                !straightBoth &&
                                line.getDistance(new Point(l1[2], l1[3])) <
                                    geomEpsilon &&
                                line.getDistance(new Point(l1[4], l1[5])) <
                                    geomEpsilon &&
                                line.getDistance(new Point(l2[2], l2[3])) <
                                    geomEpsilon &&
                                line.getDistance(new Point(l2[4], l2[5])) <
                                    geomEpsilon
                            ) {
    ...
    var CurveLocation = Base.extend(
        {
            ...
            getCurve: function () {
                ...
                function trySegment(segment) {
                    ...
                    if (
                        curve &&
                        (that._time = curve.getTimeOf(that._point)) != null
                    ) {
            ...
            isTouching: function () {
                ...
                if (
                    inter &&
                    this.getTangent().isCollinear(inter.getTangent())
                ) {
            ...
            isCrossing: function () {
                ...
                var lenghts = [];
                if (!t1Inside) lenghts.push(c1.getLength(), c2.getLength());
                if (!t2Inside) lenghts.push(c3.getLength(), c4.getLength());
    ...
    var PathItem = Item.extend({
        ...
        statics: {
            create: function (pathData) {
                var ctor =
                    ((pathData && pathData.match(/m/gi)) || []).length > 1 ||
                    /z\s*\S+/i.test(pathData)
                        ? CompoundPath
                        : Path;
        ...
        getIntersections: function (path, include, _matrix, _returnFirst) {
            ...
            if (
                !self &&
                !this.getBounds(matrix1).touches(path.getBounds(matrix2))
            )
                return [];
                ...
                for (var j = self ? i + 1 : 0; j < length2; j++) {
                    ...
                    Curve._getIntersections(
                        ...
                        locations,
                        {
                            include: include,
                            excludeStart:
                                self && curve1.getPrevious() === curve2,
        ...
        interpolate: function (from, to, factor) {
            ...
            if (current < length) {
                ...
                this[isPath ? "removeSegments" : "removeChildren"](
                    length,
                    current
                );
            }
    ...
    var Path = PathItem.extend(
        {
            ...
            copyContent: function (source) {
                ...
                if (clockwise !== undefined) this._clockwise = clockwise;
            },
            ...
            setClosed: function (closed) {
                if (this._closed != (closed = !!closed)) {
                    this._closed = closed;
                    if (this._curves) {
                        var length = (this._curves.length =
                            this._countCurves());
                        if (closed)
        ...
        },
        {
                ...
                function addSegment(segment, skipLine) {
                    ...
                    if (first) {
                        ...
                        if (
                            ...
                            if (!skipLine)
                                parts.push(
                                    "l" + f.pair(curX - prevX, curY - prevY)
                                );
                        } else {
                            parts.push(
                                "c" +
            ...
            _add: function (segs, index) {
                ...
                if (append) {
                    ...
                    for (
                        var i = index + amount, l = segments.length;
                        i < l;
                        i++
                    )
                        segments[i]._index = i;
                ...
                if (!cached || area == null) {
                    ...
                    for (var i = 0, l = closed ? count : last; i < l; i++) {
                        area += Curve.getArea(
                            Curve.getValues(
                                segments[i],
                                segments[i < last ? i + 1 : 0]
                            )
                        );
                    }
                    if (cached) this._area = area;
                }
                return area;
            },
            ...
            _updateSelection: function (segment, oldSelection, newSelection) {
                ...
                var selection = (this._segmentSelection +=
            ...
            join: function (path, tolerance) {
                ...
                if (path && path !== this) {
                    ...
                    if (last1 && last1._point.isClose(first2._point, epsilon)) {
                        ...
                        if (
                            first1 &&
                            first1._point.isClose(first2._point, epsilon)
                        )
                            path.reverse();
                        last2 = path.getLastSegment();
                        if (
                            first1 &&
                            first1._point.isClose(last2._point, epsilon)
                        ) {
                ...
                if (
                    first !== last &&
                    first._point.isClose(last._point, epsilon)
                ) {
            ...
            flatten: function (flatness) {
                ...
                if (!this._closed && length > 0) {
                    segments.push(
                        new Segment(parts[length - 1].curve.slice(6))
                    );
                }
                this.setSegments(segments);
            },
            ...
            smooth: function (options) {
                ...
                if (/^(?:asymmetric|continuous)$/.test(type)) {
                    ...
                    for (var i = 0, j = from - paddingLeft; i <= n; i++, j++) {
                        knots[i] =
                            segments[(j < 0 ? j + length : j) % length]._point;
                    }
                    ...
                    for (var i = 1; i < n; i++) {
                        ...
                        f = rf[i] = b - m;
                        x = rx[i] =
                            u * knots[i]._x + v * knots[i + 1]._x - m * x;
                        y = ry[i] =
                            u * knots[i]._y + v * knots[i + 1]._y - m * y;
                    }
            ...
            toShape: function (insert) {
                ...
                function isArc(i) {
                    ...
                    if (handle1.isOrthogonal(handle2)) {
                        ...
                        return (
                            ...
                            Numerical.isZero(
                                handle1.getLength() /
                                    corner.subtract(pt1).getLength() -
                                    kappa
                            ) &&
                            Numerical.isZero(
                                handle2.getLength() /
                                    corner.subtract(pt2).getLength() -
                                    kappa
                            )
                        );
                    }
                ...
                if (
                    ...
                    radius = size
                        .subtract(
                            new Size(getDistance(0, 7), getDistance(1, 2))
                        )
                        .divide(2);
                    topCenter = segments[3]._point
                        .add(segments[4]._point)
                        .divide(2);
                } else if (
                    segments.length === 4 &&
                    isArc(0) &&
                    ...
                    if (
                        Numerical.isZero(getDistance(0, 2) - getDistance(1, 3))
                    ) {
                        type = Shape.Circle;
                ...
                if (strokeRadius !== null) {
                    ...
                    if (loc) {
                        ...
                        if (time === 0 || (time === 1 && numSegments > 1)) {
                            ...
                            !isCloseEnough(loc.getPoint(), strokePadding)
                        ) {
                            loc = null;
                        }
                    }
            ...
            return {
                _draw: function (ctx, param, viewMatrix, strokeMatrix) {
                    ...
                    function getOffset(i) {
                        return dashArray[
                            ((i % dashLength) + dashLength) % dashLength
                        ];
                    }
            ...
            return {
                ...
                arcTo: function () {
                    ...
                    if (typeof clockwise === "boolean") {
                        ...
                        extent = vector.getDirectedAngle(
                            matrix._inverseTransform(to)
                        );
                    ...
                    for (var i = 0; i <= count; i++) {
                        ...
                        if (i < count) {
                            ...
                            if (matrix) {
                                ...
                                out = matrix
                                    ._transformPoint(vector.add(out))
                                    .subtract(pt);
                            } else {
                        ...
                        if (i === 0) {
                            ...
                            if (matrix) {
                                _in = matrix
                                    ._transformPoint(vector.add(_in))
                                    .subtract(pt);
                            }
            ...
            statics: {
                ...
                getStrokeBounds: function (
                    ...
                    var style = path.getStyle(),
                        ...
                        strokeMatrix =
                            stroke && path._getStrokeMatrix(matrix, options),
                        strokePadding =
                            stroke &&
                            Path._getStrokePadding(strokeWidth, strokeMatrix),
                    ...
                    function addRound(segment) {
                        bounds = bounds.unite(
                            joinBounds.setCenter(
                                segment._point.transform(matrix)
                            )
                        );
                    }
                ...
                _getStrokePadding: function (radius, matrix) {
                    ...
                    return [
                        Math.abs(
                            a * Math.cos(tx) * cos + b * Math.sin(tx) * sin
                        ),
                        Math.abs(
                            b * Math.sin(ty) * cos + a * Math.cos(ty) * sin
                        ),
                    ];
                },
                ...
                _addBevelJoin: function (
                    ...
                    var curve2 = segment.getCurve(),
                        ...
                        step =
                            normal1.getDirectedAngle(normal2) < 0
                                ? -radius
                                : radius;
                    normal1.setLength(step);
                    normal2.setLength(step);
                    if (matrix) matrix._transformPoint(point, point);
                    if (strokeMatrix) {
                    ...
                    if (!isArea) addPoint(point.add(normal1));
                ...
                _addSquareCap: function (
                    ...
                    if (cap === "square") {
                        point = point.add(
                            normal.rotate(loc.getTime() === 0 ? -90 : 90)
                        );
                    }
                    addPoint(point.add(normal));
                    addPoint(point.subtract(normal));
                ...
                getHandleBounds: function (
                    ...
                    var style = path.getStyle(),
                        ...
                        joinPadding;
                    if (stroke) {
                        var strokeMatrix = path._getStrokeMatrix(
                                matrix,
                                options
                            ),
                        ...
                        if (style.getStrokeCap() === "square")
                            joinRadius = Math.max(
                                joinRadius,
                                strokeRadius * Math.sqrt(2)
                            );
                        strokePadding = Path._getStrokePadding(
                            strokeRadius,
                            strokeMatrix
                        );
                        joinPadding = Path._getStrokePadding(
                            joinRadius,
                            strokeMatrix
                        );
                    }
            ...
            insertChildren: function insertChildren(index, items, _preserve) {
                for (var i = items.length - 1; i >= 0; i--) {
                    ...
                    if (item instanceof CompoundPath) {
                        ...
                        items.splice.apply(
                            items,
                            [i, 1].concat(item.removeChildren())
                        );
                        item.remove();
                    }
                }
                items = insertChildren.base.call(
                    this,
                    index,
                    items,
                    _preserve,
                ...
                for (
                    var i = 0, l = !_preserve && items && items.length;
                    i < l;
                    i++
                ) {
                    var item = items[i];
        ...
        new (function () {
            ...
            function computeBoolean(path1, path2, operation) {
                ...
                var _path1 = preparePath(path1, true),
                    _path2 =
                        path2 && path1 !== path2 && preparePath(path2, true);
                if (
                    _path2 &&
            ...
            function divideLocations(locations, include) {
                ...
                for (var i = locations.length - 1; i >= 0; i--) {
                    ...
                    if (time < tMin) {
                        ...
                        if (noHandles) clearCurves.push(curve, newCurve);
                ...
                for (var i = 0, l = segments.length; i < l; i++) {
                    ...
                    if (!seg._visited && seg._path._overlapsOnly) {
                        ...
                        if (Base.equals(segments1, segments2)) {
                            if (
                                (operator.unite || operator.intersect) &&
                                path1.getArea()
                            ) {
                                paths.push(path1.clone(false));
                            }
                            for (var j = 0, k = segments1.length; j < k; j++) {
                                segments1[j]._visited = segments2[
                                    j
                                ]._visited = true;
                            }
                        }
                    ...
                    while (true) {
                        inter =
                            (inter && findBestIntersection(inter, seg)) ||
                            inter;
                ...
                resolveCrossings: function () {
                    ...
                    var hasOverlaps = false,
                        ...
                        intersections = this.getIntersections(
                            ...
                            function (inter) {
                                return (
                                    (inter._overlap && (hasOverlaps = true)) ||
                                    (inter.isCrossing() &&
                                        (hasCrossings = true))
                                );
                            }
    ...
    var PathFitter = Base.extend({
        ...
        fitCubic: function (segments, error, first, last, tan1, tan2) {
            ...
            for (var i = 0; i <= 4; i++) {
                ...
                parametersInOrder = this.reparameterize(
                    first,
                    last,
                    uPrime,
                    curve
        ...
        generateBezier: function (first, last, uPrime, tan1, tan2) {
            ...
            if (alpha1 < eps || alpha2 < eps) {
                ...
                if (
                    handle1.dot(line) - handle2.dot(line) >
                    segLength * segLength
                ) {
                    alpha1 = alpha2 = segLength / 3;
    ...
    var PointText = TextItem.extend({
        ...
        _getBounds: function (matrix, options) {
            var style = this._style,
                ...
                leading = style.getLeading(),
                width = this.getView().getTextWidth(
                    style.getFontStyle(),
                    lines
                ),
                x = 0;
                    ...
                    Base.each(
                        ...
                        function (name, index) {
                            ...
                            this["set" + part] = function (value) {
                                ...
                                this._components[index] = parser.call(
                                    this,
                                    value
                                );
                                this._changed();
                ...
                },
                {
                    ...
                    toCSS: function (hex) {
                        var components = this._convert("rgb"),
                            alpha =
                                hex || this._alpha == null ? 1 : this._alpha;
                        function convert(val) {
                            return Math.round(
                                (val < 0 ? 0 : val > 1 ? 1 : val) * 255
                            );
                        }
                        components = [
                        ...
                        if (gradient._radial) {
                            ...
                            if (highlight) {
                                ...
                                if (vector.getLength() > radius)
                                    highlight = origin.add(
                                        vector.normalize(radius - 0.1)
                                    );
                            }
    ...
    var Gradient = Base.extend({
        ...
        _changed: function () {
            for (
                var i = 0, l = this._owners && this._owners.length;
                i < l;
                i++
            ) {
        ...
        setStops: function (stops) {
            ...
            _stops = this._stops = GradientStop.readAll(stops, 0, {
                clone: true,
            });
            for (var i = 0, l = _stops.length; i < l; i++)
            ...
            var itemDefaults = {
                ...
                fields = {
                    ...
                    initialize: function Style(style, owner, project) {
                        ...
                        this._owner = owner;
                        this._project =
                            (owner && owner._project) ||
                            project ||
                            paper.project;
                        this._defaults =
                            !owner || owner instanceof Group
                                ? groupDefaults
                                : owner instanceof TextItem
                                ? textDefaults
                                : itemDefaults;
    ...
    DomEvent.requestAnimationFrame = new (function () {
        var nativeRequest = DomElement.getPrefixed(
                window,
    ...
    var View = Base.extend(
        Emitter,
        {
            ...
            setViewSize: function () {
                ...
                this._changed();
                if (this._autoUpdate) this.requestUpdate();
            },
        ...
        ),
        {
            ...
            getEventPoint: function (event) {
                return this.viewToProject(
                    DomEvent.getOffset(event, this._element)
                );
            },
        },
        {
        ...
        new (function () {
                    ...
                    mouseout: function (event) {
                        ...
                        if (view && (!target || target.nodeName === "HTML")) {
                            var offset = DomEvent.getOffset(
                                ...
                                diff = ax - max;
                            offset.x =
                                abs(diff) < ax ? diff * (x < 0 ? -1 : 1) : x;
                            handleMouseMove(
                                view,
                                event,
                                view.viewToProject(offset)
                            );
                        }
                    },
            ...
            return {
                ...
                _handleMouseEvent: function (type, event, point) {
                    ...
                    if (handle && tool) {
                        called =
                            tool._handleMouseEvent(type, event, point, mouse) ||
                            called;
                    }
    ...
    var CanvasProvider = {
        ...
        getCanvas: function (width, height) {
            ...
            if (!ctx) {
                throw new Error(
                    "Canvas " + canvas + " is unable toprovide a 2D context."
                );
            }
    ...
    var BlendMode = new (function () {
        ...
        var modes = {
            ...
            "soft-light": function () {
                ...
                dr =
                    t +
                    (br * (255 - ((255 - br) * (255 - sr)) / 255 - t)) / 255;
                t = (sg * bg) / 255;
                dg =
                    t +
                    (bg * (255 - ((255 - bg) * (255 - sg)) / 255 - t)) / 255;
                t = (sb * bb) / 255;
                db =
                    t +
                    (bb * (255 - ((255 - bb) * (255 - sb)) / 255 - t)) / 255;
            },
            ...
            "color-dodge": function () {
                dr =
                    br === 0
                        ...
                        : sr === 255
                        ? 255
                        : min(255, (255 * br) / (255 - sr));
                dg =
                    bg === 0
                        ? 0
                        : sg === 255
                        ? 255
                        : min(255, (255 * bg) / (255 - sg));
                db =
                    bb === 0
                        ? 0
                        : sb === 255
                        ? 255
                        : min(255, (255 * bb) / (255 - sb));
            },
            ...
            Base.each(modes, function (func, mode) {
                ...
                try {
                    ...
                    if (ctx.globalCompositeOperation === mode) {
                        ...
                        ctx.fillRect(0, 0, 1, 1);
                        ok =
                            ctx.getImageData(0, 0, 1, 1).data[0] !== darken
                                ? 170
                                : 51;
                    }
                } catch (e) {}
    ...
    new (function () {
        ...
        function setDefinition(item, node, type) {
            ...
            var typeId = (definitions.ids[type] =
                (definitions.ids[type] || 0) + 1);
            node.id = type + "-" + typeId;
    ...
    new (function () {
        ...
        function getPoint(node, x, y, allowNull, allowPercent) {
            ...
            return allowNull && (x == null || y == null)
                ? null
                : new Point(x, y);
        }
        ...
        function getSize(node, w, h, allowNull, allowPercent) {
            ...
            return allowNull && (w == null || h == null)
                ? null
                : new Size(w, h);
        }
        ...
        function applyTransform(item, value, name, node) {
            if (item.transform) {
                var transforms = (node.getAttribute(name) || "").split(
                        /\)\s*/g
                    ),
                    matrix = new Matrix();
        ...
        var attributes = Base.set(
            ...
            ),
            {
                ...
                viewBox: function (item, value, name, node, styles) {
                    ...
                    if (group) {
                        if (
                            getAttribute(node, "overflow", styles) !== "visible"
                        ) {
        ...
        function importNode(node, options, isRoot) {
            ...
            var importer = importers[type],
                item =
                    (importer && importer(node, type, options, isRoot)) || null;
    ...
    Base.exports.PaperScript = function () {
        ...
        !(function (e, r) {
            return "object" == typeof exports && "object" == typeof module
                ...
                ? define(["exports"], r)
                : void r(e.acorn || (e.acorn = {}));
        })(this, function (e) {
            "use strict";
            function r(e) {
                fe = e || {};
                for (var r in he)
                    Object.prototype.hasOwnProperty.call(fe, r) ||
                        (fe[r] = he[r]);
            ...
            function s() {
                var e = fe.onComment && fe.locations && new a(),
                    ...
                    n = de.indexOf("*/", (be += 2));
                if (
                    (-1 === n && t(be - 2, "Unterminated comment"),
                    (be = n + 2),
                    fe.locations)
                ) {
                    Kr.lastIndex = r;
                    for (var o; (o = Kr.exec(de)) && o.index < be; )
                        ++Ae, (Se = o.index + o[0].length);
                }
                fe.onComment &&
                    fe.onComment(
                        !0,
            ...
            function c() {
                for (
                    var e = be,
                        r = fe.onComment && fe.locations && new a(),
                        t = de.charCodeAt((be += 2));
                    pe > be && 10 !== t && 13 !== t && 8232 !== t && 8233 !== t;

                )
                    ++be, (t = de.charCodeAt(be));
                fe.onComment &&
                    fe.onComment(
                        !1,
                        de.slice(e + 2, be),
            ...
            function u() {
                for (; pe > be; ) {
                    ...
                    if (32 === e) ++be;
                        ...
                        if (!(e >= 5760 && Jr.test(String.fromCharCode(e))))
                            break;
                        ++be;
                    }
                }
            ...
            function h(e) {
                ...
                return r === e
                    ? 45 == r &&
                      62 == de.charCodeAt(be + 2) &&
                      Gr.test(de.slice(Le, be))
                        ? ((be += 3), c(), u(), g())
                        : x(Ar, 2)
                    : 61 === r
                    ? x(Er, 2)
            ...
            function v(e) {
                var r = de.charCodeAt(be + 1),
                    t = 1;
                return r === e
                    ? ((t = 62 === e && 62 === de.charCodeAt(be + 2) ? 3 : 2),
                      61 === de.charCodeAt(be + t) ? x(Er, t + 1) : x(Tr, t))
                    : 33 == r &&
                      60 == e &&
                      45 == de.charCodeAt(be + 2) &&
                      45 == de.charCodeAt(be + 3)
                    ? ((be += 4), c(), u(), g())
                    : (61 === r && (t = 61 === de.charCodeAt(be + 2) ? 3 : 2),
                      x(Vr, t));
            }
            function b(e) {
                var r = de.charCodeAt(be + 1);
                return 61 === r
                    ? x(Or, 61 === de.charCodeAt(be + 2) ? 3 : 2)
                    : x(61 === e ? Cr : Sr, 1);
            }
            function y(e) {
                switch (e) {
            ...
            function k() {
                for (var e, r, n = "", a = be; ; ) {
                    ...
                    var o = de.charAt(be);
                    if (
                        (Gr.test(o) && t(a, "Unterminated regular expression"),
                        e)
                    )
                        e = !1;
                    else {
            ...
            function w(e, r) {
                for (
                    var t = be, n = 0, a = 0, o = null == r ? 1 / 0 : r;
                    o > a;
                    ++a
                ) {
                    var i,
            ...
            function C() {
                ...
                var e = w(16);
                return (
                    null == e && t(ye + 2, "Expected hexadecimal number"),
                    Qr(de.charCodeAt(be)) &&
                        t(be, "Identifier directly after number"),
                    i(Te, e)
                );
            }
            function E(e) {
                var r = be,
                    n = !1,
                    a = 48 === de.charCodeAt(be);
                e || null !== w(10) || t(r, "Invalid number"),
                    46 === de.charCodeAt(be) && (++be, w(10), (n = !0));
                ...
                for (var r = ""; ; ) {
                    ...
                    if (92 === n) {
                        ...
                        for (a && (a = a[0]); a && parseInt(a, 8) > 255; )
                            a = a.slice(0, -1);
                        if (("0" === a && (a = null), ++be, a))
                            Oe && t(be - 2, "Octal literal in strict mode"),
                        ...
                        (13 !== n && 10 !== n && 8232 !== n && 8233 !== n) ||
                            t(ye, "Unterminated string constant"),
                            (r += String.fromCharCode(n)),
                            ++be;
                }
            }
            ...
            function I() {
                ...
                for (var e, r = !0, n = be; ; ) {
                    ...
                    if (Yr(a)) Br && (e += de.charAt(be)), ++be;
                        ...
                        i || t(be - 1, "Invalid Unicode escape"),
                            (r ? Qr(o) : Yr(o)) ||
                                t(be - 4, "Invalid Unicode escape"),
                            (e += i);
                    }
                    r = !1;
                }
            ...
            function O() {
                (this.start = xe),
                    (this.end = null),
                    null !== me && (this.source = me);
            }
            function V() {
                var e = new R();
                return (
                    fe.locations && (e.loc = new O()),
                    fe.directSourceFile && (e.sourceFile = fe.directSourceFile),
                    fe.ranges && (e.range = [ye, 0]),
                    e
                );
            }
            function T(e) {
                ...
                return (
                    (r.start = e.start),
                    fe.locations &&
                        ((r.loc = new O()), (r.loc.start = e.loc.start)),
                    fe.ranges && (r.range = [e.range[0], 0]),
                    r
                );
            }
            function q(e, r) {
                return (
                    (e.type = r),
                    (e.end = Le),
                    fe.locations && (e.loc.end = Ue),
                    fe.ranges && (e.range[1] = Le),
                    e
                );
            }
            function j(e) {
            ...
            function B() {
                return (
                    !fe.strictSemicolons &&
                    (we === Be || we === mr || Gr.test(de.slice(Le, ye)))
                );
            }
            function M() {
                D(yr) || B() || X();
            ...
            function N(e) {
                "Identifier" !== e.type &&
                    ...
                    Oe &&
                        ...
                        t(
                            e.start,
                            "Assigning to " + e.name + " in strict mode"
                        );
            }
            function W(e) {
                (Ie = Le = be),
                    fe.locations && (Ue = new a()),
                    (Fe = Oe = null),
                    (Re = []),
                    g();
                var r = e || V(),
            ...
            function J() {
                ...
                switch (e) {
                    ...
                    case Ne:
                        ...
                        return (
                            a === Re.length &&
                                t(r.start, "Unsyntactic " + e.keyword),
                            q(r, n ? "BreakStatement" : "ContinueStatement")
                        );
                    case We:
                    ...
                    case Pe:
                        return (
                            ...
                            (r.test = P()),
                            M(),
                            q(r, "DoWhileStatement")
                        );
                    case _e:
                        if ((U(), Re.push(Zr), z(hr), we === yr))
                            return $(r, null);
                        if (we === rr) {
                            var i = V();
                            return (
                    ...
                    case Ke:
                        return (
                            ...
                            (r.test = P()),
                            (r.consequent = J()),
                            (r.alternate = D(He) ? J() : null),
                            q(r, "IfStatement")
                        );
                    case Qe:
                        return (
                            Fe ||
                                fe.allowReturnOutsideFunction ||
                                t(ye, "'return' outside of function"),
                            U(),
                            D(yr) || B()
                                ? (r.argument = null)
                                : ((r.argument = K()), M()),
                    ...
                    case Ze:
                        return (
                            U(),
                            Gr.test(de.slice(Le, ye)) &&
                                t(Le, "Illegal newline after throw"),
                            (r.argument = K()),
                            M(),
                            q(r, "ThrowStatement")
                        );
                    case er:
                        if (
                            ...
                            U(),
                                ...
                                (l.guard = null),
                                (l.body = H()),
                                (r.handler = q(l, "CatchClause"));
                        }
                        return (
                            (r.guardedHandlers = Ve),
                            (r.finalizer = D($e) ? H() : null),
                            r.handler ||
                                r.finalizer ||
                    ...
                    default:
                        ...
                        if (e === De && "Identifier" === d.type && D(gr)) {
                            ...
                            var p = we.isLoop
                                ...
                                : null;
                            return (
                                Re.push({ name: f, kind: p }),
                                (r.body = J()),
                                Re.pop(),
                                (r.label = d),
                                q(r, "LabeledStatement")
                            );
                        }
                        return (
                            (r.expression = d), M(), q(r, "ExpressionStatement")
                        );
                }
            }
            function P() {
            ...
            function G(e, r) {
                for (e.declarations = [], e.kind = "var"; ; ) {
                    ...
                    if (
                        ...
                        (n.init = D(Cr) ? K(!0, r) : null),
                        e.declarations.push(q(n, "VariableDeclarator")),
                        !D(br))
                    )
                        break;
                }
            ...
            function re() {
                if (we.prefix) {
                    ...
                    return (
                        ...
                        q(e, r ? "UpdateExpression" : "UnaryExpression")
                    );
                }
                ...
                switch (we) {
                    ...
                    case hr:
                        ...
                        return (
                            ...
                            (n.end = ge),
                            fe.locations &&
                                ((n.loc.start = r), (n.loc.end = ke)),
                            fe.ranges && (n.range = [t, ge]),
                            z(vr),
                            n
                        );
                    case fr:
            ...
            function oe() {
                ...
                return (
                    U(),
                    (e.callee = ne(ae(), !0)),
                    D(hr) ? (e.arguments = ue(vr, !1)) : (e.arguments = Ve),
                    q(e, "NewExpression")
                );
            }
            function ie() {
            ...
            function ce(e, r) {
                ...
                if (
                    ...
                    (Fe = a),
                    (Re = o),
                    Oe || (e.body.body.length && j(e.body.body[0])))
                )
                    for (var i = e.id ? -1 : 0; i < e.params.length; ++i) {
                        ...
                        if (
                            ((Xr(s.name) || Nr(s.name)) &&
                                t(
                                    s.start,
                                    "Defining '" + s.name + "' in strict mode"
                                ),
                            i >= 0)
                        )
                            for (var c = 0; i > c; ++c)
            ...
            function ue(e, r, t) {
                for (var n = [], a = !0; !D(e); ) {
                    if (a) a = !1;
                    else if ((z(br), r && fe.allowTrailingCommas && D(e)))
                        break;
            ...
            function le(e) {
                var r = V();
                return (
                    e && "everywhere" == fe.forbidReserved && (e = !1),
                    we === De
                        ? (!e &&
                              ((fe.forbidReserved &&
                                  (3 === fe.ecmaVersion ? Mr : zr)(Ce)) ||
                                  (Oe && Xr(Ce))) &&
                              -1 == de.slice(ye, ge).indexOf("\\") &&
                              t(ye, "The keyword '" + Ce + "' is reserved"),
                          (r.name = Ce))
                        : e && we.keyword
                        ? (r.name = we.keyword)
                        : X(),
            ...
            e.parse = function (e, t) {
                return (
                    (de = String(e)), (pe = de.length), r(t), o(), W(fe.program)
                );
            };
                ...
                return (
                    (n.jumpTo = function (e, r) {
                        if (((be = e), fe.locations)) {
                            ...
                            for (var t; (t = Kr.exec(de)) && t.index < e; )
                                ++Ae, (Se = t.index + t[0].length);
                        }
                        (Ee = r), u();
                    }),
                    n
            ...
            var Br,
                ...
                Qr = (e.isIdentifierStart = function (e) {
                    return 65 > e
                        ...
                        : 123 > e
                        ? !0
                        : e >= 170 && $r.test(String.fromCharCode(e));
                }),
                Yr = (e.isIdentifierChar = function (e) {
                    return 48 > e
                        ...
                        : 123 > e
                        ? !0
                        : e >= 170 && _r.test(String.fromCharCode(e));
                }),
                Zr = { kind: "loop" },
                et = { kind: "switch" };
        });
        ...
        function execute(code, scope, options) {
            ...
            var view = scope.getView(),
                ...
                func,
                compiled =
                    typeof code === "object" ? code : compile(code, options);
            code = compiled.code;
    ...
    if (paper.agent.node) require("./node/extend")(paper);
